            ...
            <div class="row">
                <div class="col-12">
                    <div class="card shadow-sm mb-4" style="border-radius: 15px;">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.withdrawals.index') }}" method="GET" class="form-inline">
                                ...
                                <a href="{{ route('admin.withdrawals.index') }}" class="btn btn-outline-secondary mb-2" title="Refresh">
                                        ...
                                        @forelse ($withdraws as $withdraw)
                                            <tr>
                                                ...
                                                <td class="action-buttons">
                                                    @if ($withdraw->status == 0)
                                                        <form action="{{ route('admin.withdrawals.approve', $withdraw->id) }}" method="post" class="d-inline">
                                                            @csrf
                                                        ...
                                                        <form action="{{ route('admin.withdrawals.reject', $withdraw->id) }}" method="post" class="d-inline">
                                                            @csrf
                                                    ...
                                                    @endif
                                                    <a href="{{ route('admin.withdrawals.view', $withdraw->id) }}" class="btn btn-info btn-sm" title="View Details"><i class="fas fa-eye"></i></a>
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
