        ...
        <div class="row mb-2">
            <div class="col-12">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.deposits.index') }}">Deposit Requests</a></li>
                    <li class="breadcrumb-item active">Deposit Request Log</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-8 col-md-10">
                <div class="card card-detail mt-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="mb-0">Deposit Request Log</h4>
                        <a href="{{ route('admin.deposits.index') }}" class="btn btn-outline-primary"><i class="fas fa-arrow-left mr-1"></i>Back</a>
                    </div>
                    <div class="mb-3">
                        @if ($deposit->status == 0)
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="info-row row">
                                ...
                                <div class="col-7 info-value"><i class="fas fa-id-card mr-1 text-secondary"></i>{{ $deposit->user->user_name }}</div>
                            </div>
                            <div class="info-row row">
                            ...
                            <div class="info-row row">
                                <div class="col-5 info-label">Request Date</div>
                            ...
                            @if ($deposit->status != 0)
                                <div class="info-row row">
                                    <div class="col-5 info-label">Updated Date</div>
                                    <div class="col-7 info-value"><i class="fas fa-calendar-check mr-1 text-info"></i>{{ $deposit->updated_at->setTimezone('Asia/Yangon')->format('d-m-Y H:i:s') }}</div>
                                </div>
                            @endif
                        </div>
                    </div>
