                    ...
                    <div class="card shadow-sm mb-4" style="border-radius: 15px;">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.deposits.index') }}" method="GET" class="form-inline">
                                ...
                                <a href="{{ route('admin.deposits.index') }}" class="btn btn-outline-secondary mb-2" title="Refresh">
                                        ...
                                        @forelse ($deposits as $deposit)
                                            <tr>
                                                ...
                                                <td class="action-buttons">
                                                    ...
                                                    @endif
                                                     <a href="{{ route('admin.deposits.view', $deposit->id) }}" class="btn btn-info btn-sm" title="View Details"><i class="fas fa-eye"></i></a>
                                                    <!-- <a href="{{ route('admin.deposits.log', $deposit->id) }}" class="btn btn-secondary btn-sm" title="View Log"><i class="fas fa-history"></i></a> -->
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
