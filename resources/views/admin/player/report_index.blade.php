        ...
        <div class="card shadow-sm">
            <div class="card-header bg-white sticky-top shadow-sm">
                <h5 class="mb-0 d-flex justify-content-between align-items-center">
                    Game Report Detail
                    <a href="{{route('admin.players.index')}}" class="btn btn-primary col-1">Back</a>
                </h5>
            </div>
                    ...
                    <tbody>
                        @foreach ($reportDetail as $data)
                            <tr class="text-center "  style="font-size: 14px !important;">
                                ...
                                <td class="text-bold">{{ number_format($data->prize_amount, 2) }}</td>
                                <?php
                                    $netWin =  number_format(  $data->prize_amount - $data->bet_amount, 2);
                                ?>
